    ...
    >
      <button
        ...
        style={{
          ...
          color: "var(--ink)",
          flex: "none",
          transition: `border-color ${ANIM_MS}ms ${ANIM_EASE}, padding ${ANIM_MS}ms ${ANIM_EASE}`,
        }}
      >
        <span
          style={{
        ...
        <span
          style={{
            fontSize: visiblyCollapsed ? 9.5 : 12,
            fontWeight: 600,
            letterSpacing: visiblyCollapsed ? "0.04em" : "-0.015em",
            lineHeight: 1,
            color: "var(--ink)",
